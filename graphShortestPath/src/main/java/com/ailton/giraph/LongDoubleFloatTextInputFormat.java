...
/**
 * Simple text-based {@link org.apache.giraph.io.VertexInputFormat} for weighted
 * graphs with long ids. Each line consists of: vertex neighbor1:weight
 * neighbor2:weight ...
 */
public class LongDoubleFloatTextInputFormat extends TextVertexInputFormat<LongWritable, DoubleWritable, FloatWritable>
	...
	@Override
	public void setConf(
			ImmutableClassesGiraphConfiguration<LongWritable, DoubleWritable, FloatWritable> configuration) {
	...
	public class LongDoubleFloatVertexReader
			extends TextVertexInputFormat<LongWritable, DoubleWritable, FloatWritable>.TextVertexReader {
		...
		public Vertex<LongWritable, DoubleWritable, FloatWritable> getCurrentVertex()
			...
			List<Edge<LongWritable, FloatWritable>> edges = Lists.newArrayListWithCapacity(tokens.length - 1);
