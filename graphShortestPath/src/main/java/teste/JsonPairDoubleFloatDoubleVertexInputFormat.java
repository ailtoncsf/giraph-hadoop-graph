 ...
 */
public class JsonPairDoubleFloatDoubleVertexInputFormat
	...
	class JsonLongDoubleFloatDoubleVertexReader
		...
		@Override
		protected Vertex<LongWritable, DoubleWritable, FloatWritable> handleException(Text line, JSONArray jsonVertex,
				JSONException e) {
